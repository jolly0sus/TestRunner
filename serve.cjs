...
//
// NOTE: this file uses the .cjs extension on purpose. package.json has
// "type": "module", so a plain .js file here would be parsed as an ES
// module (where `require` doesn't exist). .cjs always forces CommonJS.
